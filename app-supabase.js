...
function bulkBar(col) {
  return `<div id="bulk-bar-${col}" style="display:none;align-items:center;gap:10px;background:var(--red-bg);border:1.5px solid var(--red);border-radius:10px;padding:8px 14px;margin-bottom:10px;">
    <span style="font-size:13px;font-weight:700;color:var(--red)">🗑️ <span id="bulk-cnt-${col}">0</span> item dipilih</span>
    <button class="btn btn-red btn-sm" onclick="bulkDelete('${col}')">Hapus Semua Terpilih</button>
    <button class="btn btn-ghost btn-sm" onclick="clearSelection('${col}')">Batalkan</button>
  </div>`;
}
